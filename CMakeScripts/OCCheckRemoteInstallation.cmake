...
if (OPENCMISS_INSTALL_DIR_REMOTE)
    if (EXISTS "${OPENCMISS_INSTALL_DIR_REMOTE}")
        ...
        if (REMOTE_PREFIX_PATH)
            ...
            message(WARNING "No matching remote OpenCMISS installation found for the current configuration subpath '${CONFIG_PATH}'. Components will be searched/build locally.")
        endif()
    else()
