# Read OPENCMISS_SDK_INSTALL_DIR from environment if not specified directly
if (NOT OPENCMISS_SDK_INSTALL_DIR AND EXISTS "$ENV{OPENCMISS_SDK_INSTALL_DIR}")
    file(TO_CMAKE_PATH "$ENV{OPENCMISS_SDK_INSTALL_DIR}" OPENCMISS_SDK_INSTALL_DIR)
endif()
...
set(OPENCMISS_SDK_INSTALL_DIR_ARCH )
...
if (OPENCMISS_SDK_INSTALL_DIR_FORCE)
    get_filename_component(OPENCMISS_SDK_INSTALL_DIR_FORCE "${OPENCMISS_SDK_INSTALL_DIR_FORCE}" ABSOLUTE)
    set(OPENCMISS_SDK_INSTALL_DIR_ARCH "${OPENCMISS_SDK_INSTALL_DIR_FORCE}")
    if (NOT EXISTS "${OPENCMISS_SDK_INSTALL_DIR_FORCE}")
        message(FATAL_ERROR "Invalid OPENCMISS_SDK_INSTALL_DIR_FORCE directory: ${OPENCMISS_SDK_INSTALL_DIR_FORCE}")
    endif()
...
elseif(OPENCMISS_SDK_INSTALL_DIR)
    ...
    if (EXISTS "${OPENCMISS_SDK_INSTALL_DIR}")
        ...
        set(OPENCMISS_SDK_INSTALL_DIR_ARCH ${OPENCMISS_SDK_INSTALL_DIR}/${ARCH_SUBPATH})
    else()
        message(FATAL_ERROR "Invalid OPENCMISS_SDK_INSTALL_DIR directory: ${OPENCMISS_SDK_INSTALL_DIR}")
    endif()
endif()
##############
# Read remote configuration 
if (OPENCMISS_SDK_INSTALL_DIR_ARCH)
    ...
    get_remote_prefix_path(${OPENCMISS_SDK_INSTALL_DIR_ARCH} SDK_PREFIX_PATH)
    if (SDK_PREFIX_PATH)
        message(STATUS "Using remote OpenCMISS component installation at ${OPENCMISS_SDK_INSTALL_DIR_ARCH}...")
        list(APPEND CMAKE_PREFIX_PATH ${SDK_PREFIX_PATH})
        list(APPEND OPENCMISS_PREFIX_PATH ${SDK_PREFIX_PATH})
        unset(SDK_PREFIX_PATH) 
    else()
        message(FATAL_ERROR "No matching remote OpenCMISS installation found for the current configuration subpath '${ARCH_SUBPATH}' under ${OPENCMISS_SDK_INSTALL_DIR}. Please check your local setup.")
    endif()
endif()
