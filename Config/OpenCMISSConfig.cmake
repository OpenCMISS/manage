...
foreach(OCM_COMP ${OPENCMISS_COMPONENTS})
    ...
    if (NOT OCM_COMP STREQUAL MPI) # Dont show that for MPI - have different implementations
        ...
        message(STATUS "OpenCMISS component ${OCM_COMP_FIXED_SIZE}: Enabled ${OCM_USE_FIXED_SIZE}, System search ${OCM_SYSTEM_FIXED_SIZE}, Version '${OCM_VERSION_FIXED_SIZE}', Branch '${${OCM_COMP}_BRANCH}')")
    endif()
endforeach()
if (OCM_DEVEL_ALL)
