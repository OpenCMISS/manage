...
# Set diagnostic information. Done this way to maybe separate out iron and zinc at a later date.
#message(STATUS "OC with diagnostics: '${OC_WITH_DIAGNOSTICS}'")
if(DEFINED OC_WITH_DIAGNOSTICS)
    #message(STATUS "OC with diagnostics is defined")
    if(OC_WITH_DIAGNOSTICS)
        set(WITH_DIAGNOSTICS ON CACHE BOOL "Build with diagnostics enabled" FORCE)
        #message(STATUS "OC with diagnostics is enabled")
    else()
        set(WITH_DIAGNOSTICS OFF CACHE BOOL "Build with diagnostics disabled" FORCE)
        #message(STATUS "OC with diagnostics is disabled")
    endif()
endif()
#message(STATUS "With diagnostics: '${WITH_DIAGNOSTICS}'")
