...
##ELSE( UNIX )
	...
	SET( ImageMagick_DIR ${CMAKE_INSTALL_PREFIX} CACHE PATH "Where is ImageMagick installed?" )
	IF (EXISTS ${ImageMagick_DIR}/ImageMagick-config.cmake )
		INCLUDE( ${ImageMagick_DIR}/ImageMagick-config.cmake )
	ENDIF (EXISTS ${ImageMagick_DIR}/ImageMagick-config.cmake )
