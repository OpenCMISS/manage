...
if (PERL_EXECUTABLE)
  ...
  endmacro(perl_adjust_darwin_lib_variable varname)
...
set(PERL_STATIC_LIBRARIES ${PERL_STATIC_LIBRARY})
if(CRYPT_STATIC_LIBRARY)
  set(PERL_STATIC_LIBRARIES ${PERL_STATIC_LIBRARY} ${CRYPT_STATIC_LIBRARY})
endif(CRYPT_STATIC_LIBRARY)
