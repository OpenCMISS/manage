...
if(OPENCMISS_INSTALL_DIR)
    ...
    if (INSTRUMENTATION)
        set(_OCINS ${OPENCMISS_INSTALL_DIR}/cmake/OCInstrumentation.cmake)
        if (EXISTS "${_OCINS}")
            include(${_OCINS})
        else()
            message(WARNING "INSTRUMENTATION specified but OpenCMISS config script could not be found at ${_OCINS}. Trying CMake defaults.")
        endif()
        unset(_OCINS)
    endif()
