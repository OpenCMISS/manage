...
if (GTEST IN_LIST OC_REQUIRED_COMPONENTS)
...
if (ZLIB IN_LIST OC_REQUIRED_COMPONENTS)
...
message(STATUS "ZLIB_FIND_SYSTEM: ${ZLIB_FIND_SYSTEM}")
message(STATUS "LIBXML2_FIND_SYSTEM: ${LIBXML2_FIND_SYSTEM}")
...
if (LAPACK IN_LIST OC_REQUIRED_COMPONENTS)
...
# hdf5
if (HDF5 IN_LIST OC_REQUIRED_COMPONENTS)
    # szip
    if (OC_USE_SZIP)
...
# Fieldml
if (FIELDML-API IN_LIST OC_REQUIRED_COMPONENTS)
...
# PLAPACK
if (PLAPACK IN_LIST OC_REQUIRED_COMPONENTS)
...
# ScaLAPACK
if (SCALAPACK IN_LIST OC_REQUIRED_COMPONENTS)
...
# parMETIS 4 (+METIS 5)
if (PARMETIS IN_LIST OC_REQUIRED_COMPONENTS)
...
if (SUITESPARSE IN_LIST OC_REQUIRED_COMPONENTS)
...
# SuperLU 4.3
if (SUPERLU IN_LIST OC_REQUIRED_COMPONENTS)
...
# Hypre 2.9.0b
if (HYPRE IN_LIST OC_REQUIRED_COMPONENTS)
...
# SuperLU-DIST 4.0
if (SUPERLU_DIST IN_LIST OC_REQUIRED_COMPONENTS)
...
# Sundials 2.5
if (SUNDIALS IN_LIST OC_REQUIRED_COMPONENTS)
...
# Pastix 5.2.2.16
if (PASTIX IN_LIST OC_REQUIRED_COMPONENTS)
...
if (SOWING IN_LIST OC_REQUIRED_COMPONENTS)
...
# PETSc 3.5
if (PETSC IN_LIST OC_REQUIRED_COMPONENTS)
...
# SLEPc 3.5
if (SLEPC IN_LIST OC_REQUIRED_COMPONENTS)
...
# CellML
if (LIBCELLML IN_LIST OC_REQUIRED_COMPONENTS)
...
if (CSIM IN_LIST OC_REQUIRED_COMPONENTS)
    if (LLVM IN_LIST OC_REQUIRED_COMPONENTS)
    ...
    if (CLANG IN_LIST OC_REQUIRED_COMPONENTS)
...
if (CELLML IN_LIST OC_REQUIRED_COMPONENTS)
...
if (IRON IN_LIST OC_REQUIRED_COMPONENTS)
    set(SUBGROUP_PATH .)
...
# jpeg
if (JPEG IN_LIST OC_REQUIRED_COMPONENTS)
...
# netgen
if (NETGEN IN_LIST OC_REQUIRED_COMPONENTS)
...
# Freetype
if (FREETYPE IN_LIST OC_REQUIRED_COMPONENTS)
...
# FTGL
if (FTGL IN_LIST OC_REQUIRED_COMPONENTS)
...
# GLEW
if (GLEW IN_LIST OC_REQUIRED_COMPONENTS)
...
# opt++
if (OPTPP IN_LIST OC_REQUIRED_COMPONENTS)
...
# tiff
if (TIFF IN_LIST OC_REQUIRED_COMPONENTS)
...
# gdcm
if (GDCM-ABI IN_LIST OC_REQUIRED_COMPONENTS)
...
if (IMAGEMAGICK IN_LIST OC_REQUIRED_COMPONENTS)
...
if (ITK IN_LIST OC_REQUIRED_COMPONENTS)
...
if (ZINC IN_LIST OC_REQUIRED_COMPONENTS)
    ...
    addAndConfigureLocalComponent(ZINC
        ...
        GTEST_VERSION=${GTEST_VERSION}
        ZN_VIRTUALENV_INSTALL_PREFIX=${_VIRTUALENV_INSTALL_PREFIX}
