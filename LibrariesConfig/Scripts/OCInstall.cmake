...
function(DO_EXPORT CFILE VARS)
    ...
    if (CFILE_TYPE STREQUAL "context")
        ...
        file(APPEND ${CFILE} "\n")
        file(APPEND ${CFILE} "foreach(_PREFIX_PATH \${_DIR} \${_OPENCMISS_CONTEXT_IMPORT_PREFIX}/${OPENCMISS_DEPENDENCIES_INSTALL_PREFIX_IMPORT})\n")
...
relativize_path_list(OPENCMISS_PREFIX_PATH_IMPORT "${OPENCMISS_LIBRARIES_INSTALL_NO_MPI_PREFIX}" _OPENCMISS_CONTEXT_IMPORT_PREFIX)
set(OPENCMISS_LIBRARY_PATH_IMPORT ${OPENCMISS_LIBRARY_PATH_NO_MPI})
relativize_path_list(OPENCMISS_LIBRARY_PATH_IMPORT "${OPENCMISS_LIBRARIES_INSTALL_NO_MPI_PREFIX}" _OPENCMISS_CONTEXT_IMPORT_PREFIX)
set(OPENCMISS_BINARIES_PATH_IMPORT ${OPENCMISS_BINARIES_PATH_NO_MPI})
relativize_path_list(OPENCMISS_BINARIES_PATH_IMPORT "${OPENCMISS_LIBRARIES_INSTALL_NO_MPI_PREFIX}" _OPENCMISS_CONTEXT_IMPORT_PREFIX)
...
if (NOT OPENCMISS_DEPENDENCIES_ONLY)
    relativize_path_list(OPENCMISS_DEPENDENCIES_INSTALL_PREFIX_IMPORT "${OPENCMISS_DEPENDENCIES_INSTALL_PREFIX}" _OPENCMISS_CONTEXT_IMPORT_PREFIX)
...
relativize_path_list(OPENCMISS_MPI_PREFIX_PATH_IMPORT "${OPENCMISS_LIBRARIES_INSTALL_NO_MPI_PREFIX}" _OPENCMISS_CONTEXT_IMPORT_PREFIX)
set(OPENCMISS_MPI_LIBRARY_PATH_IMPORT ${OPENCMISS_LIBRARY_PATH_MPI})
relativize_path_list(OPENCMISS_MPI_LIBRARY_PATH_IMPORT "${OPENCMISS_LIBRARIES_INSTALL_NO_MPI_PREFIX}" _OPENCMISS_CONTEXT_IMPORT_PREFIX)
set(OPENCMISS_MPI_BINARIES_PATH_IMPORT ${OPENCMISS_BINARIES_PATH_MPI})
relativize_path_list(OPENCMISS_MPI_BINARIES_PATH_IMPORT "${OPENCMISS_LIBRARIES_INSTALL_NO_MPI_PREFIX}" _OPENCMISS_CONTEXT_IMPORT_PREFIX)
