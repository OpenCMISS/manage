...
function(DO_EXPORT CFILE VARS)
    ...
    if (CFILE_TYPE STREQUAL "context")
        ...
        file(APPEND ${CFILE} "\n")
        file(APPEND ${CFILE} "if (EXISTS \"\${_CONTEXT_OPENCMISS_IMPORT_PREFIX}/${OPENCMISS_DEPENDENCIES_INSTALL_PREFIX_IMPORT}/context-dependencies.cmake\")\n")
        file(APPEND ${CFILE} "    include(\${_CONTEXT_OPENCMISS_IMPORT_PREFIX}/${OPENCMISS_DEPENDENCIES_INSTALL_PREFIX_IMPORT}/context-dependencies.cmake)\n")
...
if (OPENCMISS_DEPENDENCIES_ONLY)
    ...
    list(REMOVE_DUPLICATES OPENCMISS_BINARIES_PATH_IMPORT)
    relativize_path_list(OPENCMISS_DEPENDENCIES_INSTALL_PREFIX_IMPORT "${OPENCMISS_DEPENDENCIES_INSTALL_PREFIX}" _CONTEXT_OPENCMISS_IMPORT_PREFIX)
