...
if(iron IN_LIST OpenCMISSLibs_FIND_COMPONENTS)
    ...
    if (NOT OPENCMISS_MPI STREQUAL CONTEXT_OPENCMISS_MPI)
        message(FATAL_ERROR "Mismatch between the current context MPI (${CONTEXT_OPENCMISS_MPI}) and the MPI found (${OPENCMISS_MPI}).")
    endif ()
